...
$('#iframeautoheight').contents().find('select').removeAttr("disabled").val("优秀");
$('#iframeautoheight').contents().find('select:last').removeAttr("disabled").val("良好");
$('#iframeautoheight').contents().find('#Button1').click()//点击保存按钮


$('#iframeautoheight').contents().find('select:first').removeAttr("disabled").val("良好");
